...
const setUp = (givenSpec: BatchSkill) => {
  ...
  const component = shallow(<BatchCard batch={props} searchTexts={[]} />);
  return component;
};
...
describe("Batch Card Component", () => {
  ...
  let devComp: any;
  beforeEach(() => {
    //places the fake batch card into the component variable
  ...
  it("Should render all of the correct images", () => {
    ...
    expect(JSON.stringify(image.prop("src"))).toEqual(
      JSON.stringify(reactReduxLogo)
    );
