...
export const LoginComponent: React.FC<ILoginProps> = (props: ILoginProps) => {
    ...
    const handleSubmit = async (event: any) => {
        ...
        try {
            ...
            const user = await Auth.signIn( // !!!EMAIL WILL BE RETURNED IN: user.attributes.email
...
export class CEPLoginInputStyle implements React.CSSProperties {
    ...
    constructor() {
        ...
        this.boxShadow =
            "inset 1px 2px 0 0 #ddd, inset 0 4px 0 0 #eee, inset 2px 6px 0 0 #fef";
    }
}
