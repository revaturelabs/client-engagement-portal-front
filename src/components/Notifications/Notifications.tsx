 ...
 */
const Notifications: React.FC<INotificationState> = (
  props: INotificationState
) => {
          ...
          <Accordion className="notifs">
            {props.notifications?.map((e, i) => (
              <>
                ...
                >
                  <div id="head">
                    <div id="companyName">{e.client.companyName}</div>
                    <div id="requestType">{e.requestType}</div>
                    <div id="dateCreated">{e.dateCreated}</div>
                  </div>
                </Accordion.Toggle>
